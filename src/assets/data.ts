...
type Countries = { [key: string]: SingleCountry };
...
const countries: Countries = {
  ...
  BQ: {
    ...
    fr: 'Bonaire, Saba, Sint Eustatius (Pays-Bas)',
  },
  BR: {
    de: 'Brasilien',
    en: 'Brazil',
  ...
  EH: {
    ...
    fr: 'République arabe saraouie démocratique',
  },
  ER: {
    de: 'Eritrea',
    en: 'Eritrea',
  ...
  SJ: {
    ...
    fr: 'Svalbard et Jan Mayen (Norvège)',
  },
  SK: {
    de: 'Slowakei',
    en: 'Slovakia',
  ...
  UM: {
    ...
    fr: 'Îles mineures éloignées des États-Unis (États-Unis)',
  },
  US: {
